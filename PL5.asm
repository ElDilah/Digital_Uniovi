...
;INICIALIZACION
CONFIG BSF STATUS,RP0  ;CAMBIO A BANCO 1 
    ...
    CLRF ANTESA    ;"EN ANTES A"
    CLRF ANTESB    ;"EN ANTES B"
;BUCLE
BUCLE 
...
MOSTRAR ADDWL PCL,F  ;SELECCION DE EFECTO 
...
EFECTO_0 INCF ESTADO 
   ...
   MOVWF PORTC ;MOVEMOS EL CODIGO OBTENIDO A PORT D
...
EFECTO_3 INCF ESTADO
   MOVF ESTADO,W ;
   CALL TAB_3	;TABLA DEL SEGUNDO EFECTO
   MOVWF PORTC	;MOSTRAR 
   GOTO COMUN	;TRASLADAR A COMUNÇ
TAB_1 ADDWF PCL,F 
